      ...
      <main>
              ...
              <div id="intro-left-container">
                ...
                <ul id="secondarynav">
                  ...
                  <li className="social">
                    ...
                    <a href={Constants.discordInviteURL}>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="40"
                        height="30.316"
        ...
        <section id="airdrop-calendar">
          ...
          <p>
            ...
            <br />
            <br />
            Each SKULL is both a collectible art piece and also a skeleton key
            to our 2021 Halloween event:{" "}
            <strong>
          ...
          <p>
            Every single day in October, SKULL holders had the chance to be
            airdropped exclusive and rare SKULLS (and other goodies). Every
            SKULL you held in your wallet increased your chance of winning an
            item, but not all items were equally rare.
          </p>
          <div id="calendar">
            <ol>
            ...
            <ul>
              ...
              <li className="completed">
                ...
                <span className="roadmap-item-description">
                  We’ve{" "}
                  <a
                    href="https://github.com/theskeletoncrew/air-support"
                    target="_blank"
                    rel="noreferrer"
                  >
                    developed tools
                  </a>{" "}
                  to automate our #31daysofairdrops and plan on open sourcing
                  this to the public. We want to give the Solana ecosystem
                  another little taste of what the Skeleton Crew is capable of
                  delivering; filling common technology gaps, while
                  simultaneously building out premium offerings for super users.
                </span>
              </li>
              <li className="completed">
                <span className="roadmap-dot"></span>
          ...
          <ul>
            ...
            <li>
              ...
              <p>
                ...
                <br />
                exclusively to SKULL holders, Oct 2021.
              </p>
            </li>
          </ul>
